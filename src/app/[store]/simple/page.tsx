            ...
            <div className="flex-1 max-w-lg mx-8">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-[#112e40] placeholder-gray-500"
                />
            ...
            <div className="space-y-4">
              {displayProducts.slice(0, 6).map((product) => (
                <div key={product.id} className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
                  <img 
                    src={product.image_url || product.primary_image_url || product.image || 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=300&h=200&fit=crop'} 
                    alt={product.name} 
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-semibold text-[#112e40]">{(product.price || 0).toLocaleString()}</span>
                    </div>
                    <div className="flex gap-1 mb-2">
                      <span className="bg-gray-100 border border-gray-200 text-[#112e40] px-2 py-1 rounded text-xs">
                        {product.category?.name || product.category || 'FOOD'}
                      </span>
          ...
          <div className="flex-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-6">
                {displayProducts.slice(6, 15).map((product, index) => (
                  <div key={index} className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-semibold text-[#112e40]">{(product.price || 0).toLocaleString()}</span>
                      </div>
                      ...
                      <button 
                        onClick={() => addItem(product)}
                        className="w-full bg-white text-[#112e40] border border-gray-300 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 transition"
                      >
                        ADD TO CART
                      </button>
                    </div>
